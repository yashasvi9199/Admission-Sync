...
-- -- Date: 2026-06-30
-- -- Time: 11:32 IST
-- -- Feature: user-password-column-fix
-- -- Type: FIX
-- -- Notes: Add password column to existing users table via ALTER TABLE migration
-- -- ============================================================
...
-- -- Migration to add password column to existing users table if it does not exist (handled via check in functions or explicit ALTER TABLE)
