...
- **Date**: 2026-07-01
- **Core Changes**: Fixed login in native Capacitor app by using Capacitor.isNativePlatform(). Fixed midnight auto punchout database persistence. Dynamic shift duration support in HoursTab. Replaced logs feed with a monthly calendar-based selector UI for filtering and CRUD logs.
- **Next Immediate Objectives**: Perform integration test on native emulator and request user feedback.
